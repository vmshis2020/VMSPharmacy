...
{
    public partial class frm_themmoi_phieuxuatkho_benhnhan_noitru_tututruc : Form
    {
        ...
        public frm_themmoi_phieuxuatkho_benhnhan_noitru_tututruc(string KIEU_THUOC_VT)
        {
            InitializeComponent();
        ...
        void Initevents()
        {
            ...
            this.KeyDown += new KeyEventHandler(frm_themmoi_phieuxuatkho_benhnhan_noitru_tututruc_KeyDown);
            ...
            cboKhoaXuat.SelectedIndexChanged += new EventHandler(cboKhoaXuat_SelectedIndexChanged);
        }

        void cboKhoaXuat_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (!b_Hasloaded) return;
                string IDKhoa = cboKhoaXuat.SelectedValue.ToString();
        ...
        void frm_themmoi_phieuxuatkho_benhnhan_noitru_tututruc_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void LoadKho()
        {
            ...
            DataBinding.BindDataCombobox(cboKhoaXuat, m_KhoaLinh,
                                      DmucKhoaphong.Columns.IdKhoaphong, DmucKhoaphong.Columns.TenKhoaphong, "--Chọn khoa xuất--", true);
        ...
        private void getData()
        {
            if (m_enAction == action.Update)
            {
                ...
                if (objPhieuNhap != null)
                {
                    ...
                    cboKhoaXuat.SelectedIndex = Utility.GetSelectedIndex(cboKhoaXuat, Utility.sDbnull(objPhieuNhap.IdKhoalinh));
        ...
        private void frm_themmoi_phieuxuatkho_benhnhan_noitru_tututruc_Load(object sender, EventArgs e)
        {
        ...
        private TPhieuNhapxuatthuoc CreatePhieuNhapKho()
        {
            ...
            objTPhieuNhapxuatthuoc.IdKhoalinh = Utility.Int16Dbnull(cboKhoaXuat.SelectedValue, 0);
            ...
            objTPhieuNhapxuatthuoc.LoaiPhieu = (byte)LoaiPhieu.PhieuXuatKhoBenhNhanTuTutruc;
            objTPhieuNhapxuatthuoc.TenLoaiphieu = Utility.TenLoaiPhieu(LoaiPhieu.PhieuXuatKhoBenhNhanTuTutruc);
        ...
        private void ThemPhieuXuatKho()
        {
            ...
            switch (actionResult)
            {
                case ActionResult.Success:
                    ...
                    newDr["ten_khoa"] = Utility.sDbnull(cboKhoaXuat.Text);
        ...
        private bool IsValidData()
        {
            ...
            if (cboKhoaXuat.SelectedValue.ToString() == "-1")
            {
