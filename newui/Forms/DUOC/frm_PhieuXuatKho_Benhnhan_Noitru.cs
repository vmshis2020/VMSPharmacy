...
{
    public partial class frm_PhieuXuatKho_Benhnhan_Noitru : Form
    {
        ...
        private string FileName = string.Format("{0}/{1}", Application.StartupPath, string.Format("SplitterDistancefrm_PhieuXuatKho_Benhnhan_Noitru.txt"));
        ...
        public frm_PhieuXuatKho_Benhnhan_Noitru(string KIEU_THUOC_VT)
        {
            InitializeComponent();
            ...
            this.KeyDown += new KeyEventHandler(frm_PhieuXuatKho_Benhnhan_Noitru_KeyDown);
        ...
        /// <param name="e"></param>
        private void frm_PhieuXuatKho_Benhnhan_Noitru_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void TIMKIEM_THONGTIN()
        {
            ...
            m_dtDataNhapKho =
                new THUOC_NHAPKHO().Laydanhsachphieunhapkho(chkByDate.Checked ? dtFromdate.Value.ToString("dd/MM/yyyy") :"01/01/1900",
                                             ...
                                             -1, "-1", Utility.sDbnull(txtSoPhieu.Text), TRANG_THAI,(int) LoaiPhieu.PhieuXuatKho, MaKho,1, KIEU_THUOC_VT);
        ...
        private void frm_PhieuXuatKho_Benhnhan_Noitru_Load(object sender, EventArgs e)
        {
        ...
        private void InitData()
        {
            if (KIEU_THUOC_VT == "THUOC")
            {
                ...
                m_dtKhoNhap = CommonLoadDuoc.LAYTHONGTIN_KHOTHUOC_AO(true);
            }
            else
            {
                m_dtKhoXuat = CommonLoadDuoc.LAYTHONGTIN_KHOVATTU_LE(new List<string> { "TATCA", "NGOAITRU", "NOITRU" });
                m_dtKhoNhap = CommonLoadDuoc.LAYTHONGTIN_KHOVATTU_AO(true);
            }
        ...
        private void cmdThemPhieuNhap_Click(object sender, EventArgs e)
        {
            try
            {
                frm_themmoi_phieuxuatkho_benhnhan_noitru frm = new frm_themmoi_phieuxuatkho_benhnhan_noitru();
