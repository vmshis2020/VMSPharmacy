...
namespace VNS.HIS.DAL
{
    ...
    public partial class TPhieuXuatthuocBenhnhanChitietController
    {
	    ...
	    public void Insert(long IdPhieu,short? IdKho,int IdThuoc,int SoLuong,decimal DonGia,decimal GiaNhap,decimal? GiaBan,decimal? GiaBhyt,decimal? PhuthuDungtuyen,decimal? PhuthuTraituyen,string SoLo,int Vat,DateTime NgayHethan,long IdChitietdonthuoc,long? IdDonthuoc,string ChiDan,long? IdThuockho,string MaNhacungcap,DateTime? NgayNhap,string SoDky,string SoQdinhthau)
	    {
