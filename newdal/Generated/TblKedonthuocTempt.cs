...
namespace VNS.HIS.DAL
{
	...
	public partial class TblKedonthuocTempt : ActiveRecord<TblKedonthuocTempt>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long varIdChitietdonthuoc,long varIdDonthuoc,int varIdKho,int varIdThuoc,long varIdThuockho,byte varTrangThai,DateTime varNgayKedon,int varSoLuong)
		{
		...
		/// </summary>
		public static void Update(long varIdChitietdonthuoc,long varIdDonthuoc,int varIdKho,int varIdThuoc,long varIdThuockho,byte varTrangThai,DateTime varNgayKedon,int varSoLuong)
		{
			TblKedonthuocTempt item = new TblKedonthuocTempt();
