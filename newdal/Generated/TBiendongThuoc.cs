...
namespace VNS.HIS.DAL
{
	...
	public partial class TBiendongThuoc : ActiveRecord<TBiendongThuoc>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaPhieu,short? varIdKho,int varIdThuoc,DateTime? varNgayHethan,int? varSoLuong,int? varSluongChia,decimal? varDonGia,decimal? varThanhTien,decimal? varPhuThu,int? varIdPhieuChitiet,int? varIdPhieu,int? varVat,long? varIdBenhnhan,string varMaLuotkham,short? varIdDoituongKcb,string varSoHoadon,string varMaNhacungcap,byte? varMaLoaiphieu,string varTenLoaiphieu,DateTime? varNgayHoadon,DateTime? varNgayBiendong,short? varIdNhanvien,string varNguoiTao,DateTime? varNgayTao,short? varIdKhoaLinh,decimal? varGiaBan,decimal? varGiaNhap,string varSoLo,long? varIdThuockho,long? varIdChuyen,string varKieuThuocvattu,string varMotaThem,string varSoChungtuKemtheo,byte? varNoitru,byte? varQuayThuoc,decimal? varGiaBhyt,decimal? varGiaBhytCu,decimal? varGiaPhuthuDungtuyen,decimal? varGiaPhuthuTraituyen,byte? varDuTru,DateTime? varNgayNhap,string varKieuBiendong,byte? varThuocVay,string varSoDky,string varSoQdinhthau)
		{
		...
		/// </summary>
		public static void Update(long varIdBiendong,string varMaPhieu,short? varIdKho,int varIdThuoc,DateTime? varNgayHethan,int? varSoLuong,int? varSluongChia,decimal? varDonGia,decimal? varThanhTien,decimal? varPhuThu,int? varIdPhieuChitiet,int? varIdPhieu,int? varVat,long? varIdBenhnhan,string varMaLuotkham,short? varIdDoituongKcb,string varSoHoadon,string varMaNhacungcap,byte? varMaLoaiphieu,string varTenLoaiphieu,DateTime? varNgayHoadon,DateTime? varNgayBiendong,short? varIdNhanvien,string varNguoiTao,DateTime? varNgayTao,short? varIdKhoaLinh,decimal? varGiaBan,decimal? varGiaNhap,string varSoLo,long? varIdThuockho,long? varIdChuyen,string varKieuThuocvattu,string varMotaThem,string varSoChungtuKemtheo,byte? varNoitru,byte? varQuayThuoc,decimal? varGiaBhyt,decimal? varGiaBhytCu,decimal? varGiaPhuthuDungtuyen,decimal? varGiaPhuthuTraituyen,byte? varDuTru,DateTime? varNgayNhap,string varKieuBiendong,byte? varThuocVay,string varSoDky,string varSoQdinhthau)
		{
			TBiendongThuoc item = new TBiendongThuoc();
