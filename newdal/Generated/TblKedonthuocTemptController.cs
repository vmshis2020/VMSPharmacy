...
namespace VNS.HIS.DAL
{
    ...
    public partial class TblKedonthuocTemptController
    {
	    ...
	    public void Insert(long IdChitietdonthuoc,long IdDonthuoc,int IdKho,int IdThuoc,long IdThuockho,byte TrangThai,DateTime NgayKedon,int SoLuong)
	    {
	    ...
	    public void Update(long IdChitietdonthuoc,long IdDonthuoc,int IdKho,int IdThuoc,long IdThuockho,byte TrangThai,DateTime NgayKedon,int SoLuong)
	    {
		    TblKedonthuocTempt item = new TblKedonthuocTempt();
	        item.MarkOld();
	        item.IsLoaded = true;
