	...
	public partial class TPhieuCapphatChitiet : ActiveRecord<TPhieuCapphatChitiet>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarThucLinh.DataType = DbType.Int32;
				...
				colvarSoLuongtralai.DataType = DbType.Int32;
		...
		public int? ThucLinh 
		{
			get { return GetColumnValue<int?>(Columns.ThucLinh); }
		...
		{
			get { return GetColumnValue<int?>(Columns.SoLuongtralai); }
		...
		/// </summary>
		public static void Insert(int varIdCapphat,int varIdDonthuoc,int varIdChitietdonthuoc,DateTime? varNgayKedon,long? varIdBenhnhan,string varMaLuotkham,short? varDaLinh,int varSoLuong,int? varThucLinh,int? varSoLuongtralai,int varIdThuoc,int varIdKho,long? varIdThuockho,long? varIdPhieuxuatthuocBenhnhan,string varNguoiSua,DateTime? varNgaySua,long? varIdPhieutralai,byte? varTrangthaiTralai)
		{
