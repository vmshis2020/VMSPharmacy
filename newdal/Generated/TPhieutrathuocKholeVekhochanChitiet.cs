...
{
	/// <summary>
	/// Strongly-typed collection for the TPhieutrathuocKholeVekhochanChitiet class.
	/// </summary>
    [Serializable]
	public partial class TPhieutrathuocKholeVekhochanChitietCollection : ActiveList<TPhieutrathuocKholeVekhochanChitiet, TPhieutrathuocKholeVekhochanChitietCollection>
	{	   
		public TPhieutrathuocKholeVekhochanChitietCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TPhieutrathuocKholeVekhochanChitietCollection</returns>
		public TPhieutrathuocKholeVekhochanChitietCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TPhieutrathuocKholeVekhochanChitiet o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the t_phieutrathuoc_khole_vekhochan_chitiet table.
	/// </summary>
	[Serializable]
	public partial class TPhieutrathuocKholeVekhochanChitiet : ActiveRecord<TPhieutrathuocKholeVekhochanChitiet>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TPhieutrathuocKholeVekhochanChitiet()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TPhieutrathuocKholeVekhochanChitiet(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TPhieutrathuocKholeVekhochanChitiet(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TPhieutrathuocKholeVekhochanChitiet(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("t_phieutrathuoc_khole_vekhochan_chitiet", TableType.Table, DataService.GetInstance("ORM"));
				...
				colvarMaNhacungcap.MaxLength = 10;
				...
				DataService.Providers["ORM"].AddSchema("t_phieutrathuoc_khole_vekhochan_chitiet",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(long varIdPhieu,DateTime varNgayHethan,int varIdThuoc,decimal varGiaNhap,decimal varGiaBan,decimal? varDonGia,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,int varSoLuong,string varSoLo,int? varChietKhau,decimal varThanhTien,decimal varVat,long? varIdThuockho,long? varIdChuyen,string varMaNhacungcap,string varKieuThuocvattu,short? varThangDu,decimal? varGiaBhyt,DateTime? varNgayNhap,string varSoDky,string varSoQdinhthau)
		{
		...
		/// </summary>
		public static void Update(long varIdPhieuChitiet,long varIdPhieu,DateTime varNgayHethan,int varIdThuoc,decimal varGiaNhap,decimal varGiaBan,decimal? varDonGia,decimal? varPhuthuDungtuyen,decimal? varPhuthuTraituyen,int varSoLuong,string varSoLo,int? varChietKhau,decimal varThanhTien,decimal varVat,long? varIdThuockho,long? varIdChuyen,string varMaNhacungcap,string varKieuThuocvattu,short? varThangDu,decimal? varGiaBhyt,DateTime? varNgayNhap,string varSoDky,string varSoQdinhthau)
		{
			TPhieutrathuocKholeVekhochanChitiet item = new TPhieutrathuocKholeVekhochanChitiet();
