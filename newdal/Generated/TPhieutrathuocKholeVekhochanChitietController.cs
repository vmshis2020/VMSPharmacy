...
namespace VNS.HIS.DAL
{
    ...
    public partial class TPhieutrathuocKholeVekhochanChitietController
    {
	    ...
	    public void Insert(long IdPhieu,DateTime NgayHethan,int IdThuoc,decimal GiaNhap,decimal GiaBan,decimal? DonGia,decimal? PhuthuDungtuyen,decimal? PhuthuTraituyen,int SoLuong,string SoLo,int? ChietKhau,decimal ThanhTien,decimal Vat,long? IdThuockho,long? IdChuyen,string MaNhacungcap,string KieuThuocvattu,short? ThangDu,decimal? GiaBhyt,DateTime? NgayNhap,string SoDky,string SoQdinhthau)
	    {
