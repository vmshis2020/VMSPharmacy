...
namespace VNS.HIS.DAL
{
    ...
    public partial class SysVersionController
    {
	    ...
	    public void Insert(string SFileName,string SRarFileName,byte[] ObjData,string SVersion,short? IntRar,short? IntPatch,DateTime? TUpdatedDate,int? DblCapacity,string SDesc,byte? IsUpdate,string SFolder,byte? BytConfirmed)
	    {
